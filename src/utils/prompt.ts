...
import * as torrentUtils from './torrent'
import * as subtitleUtils from './subtitles'
...
export async function title(message: string, titles: any[]) {
  ...
  titles.forEach((title: any) => {
    ...
    row.push(torrentUtils.parseTitle(title.title))
...
export async function subtitles(message: string, subtitlesAll: any) {
  ...
  subtitlesAll.forEach((subtitles: any) => {
    ...
    row.push(subtitleUtils.parseTitle(subtitles.filename))
